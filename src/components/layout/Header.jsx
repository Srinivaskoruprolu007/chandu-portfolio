...
const Header = () => {
  ...
  return (
    <motion.div
      ...
      className="sticky top-0 z-50 flex flex-col md:flex-row justify-between items-center px-4 bg-black dark:bg-white text-white dark:text-black h-20 max-w-screen border-b border-gray-800 dark:border-gray-200"
    >
