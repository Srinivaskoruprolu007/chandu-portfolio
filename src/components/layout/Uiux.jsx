  ...
  return (
    <div className="bg-black dark:bg-white text-white dark:text-black p-6 sm:p-12 w-full flex flex-col justify-center">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between w-full">
        ...
        <Button className="bg-[#4A2CED] dark:bg-[#6B4EF7] rounded-full py-3 px-6 sm:py-4 sm:px-8 shadow-lg mt-4 sm:mt-0 hover:bg-[#3920B5] dark:hover:bg-[#5437D6] transition-colors">
